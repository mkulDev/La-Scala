...
const message = {
  ...
  body:
    'Serdecznie zapraszamy do pizzerii La Scala. Oferujemy Państwu bogatą ofertę dań kuchni włoskiej, m.in. pyszną pizzę wg oryginalnej receptury, ze składnikami jakich nie znajdziecie w okolicy, różnorodne pasty oraz sałatki.',
  btn: 'Zobacz menu',
  btnId: 'menu',
}
